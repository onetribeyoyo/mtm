...
environments {
    development {
        ...
        // set the bootstrap project properties from the command line (e.g. -Dmtm.bootstrap.filename=mystories.csv)
        mtm.bootstrap.filename = System.getProperty("mtm.bootstrap.filename") ?: "bootstrap-project.csv"
    }
    production {
...
log4j = {
    ...
    warn  "grails.app.resourceMappers.org.grails.plugin.resource",
